...
-- 6. SERVICES_CATEGORIES (powiązania usług z kategoriami)
...
-- 7. EMPLOYEES_SERVICES (który pracownik wykonuje które usługi)
...
-- 8. SERVICE_WITH_DATE (konkretne terminy dla usług + przypisanie do pracownika)
...
-- 13. BUSINESSES_PHOTOS (zdjęcia firm - dla przykładu puste bytea)
